...
def send_contrarian_win_alert(wallet_address: str, username: str, contrarian_win: dict) -> bool:
    ...
    embed = _build_embed(wallet_address, username, contrarian_win)
    return _post({"embeds": [embed]})


def _build_embed(wallet_address: str, username: str, w: dict) -> dict:
